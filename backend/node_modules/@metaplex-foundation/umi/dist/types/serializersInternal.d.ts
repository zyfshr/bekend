...
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
export declare const utf8: _Serializer<string>;
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
export declare const baseX: (alphabet: string) => _Serializer<string>;
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
export declare const base10: _Serializer<string>;
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
export declare const base58: _Serializer<string>;
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
export declare const base64: _Serializer<string>;
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
export declare const base16: _Serializer<string>;
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
export declare const bitArray: (size: number, options?: import("@metaplex-foundation/umi-serializers").BitArraySerializerOptions | boolean) => _Serializer<boolean[]>;
/** @deprecated import from "@metaplex-foundation/umi/serializers" instead. */
