...
function createUmi(endpointOrConnection, rpcOptions) {
  return umi.createBaseUmi().use(typeof endpointOrConnection === 'string' ? plugin.defaultPlugins(endpointOrConnection, rpcOptions) : plugin.defaultPlugins(endpointOrConnection, rpcOptions));
}
