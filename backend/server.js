...
const APP_UPDATE_INFO = {
  ...
  bundleId: "com.example.myapp",        // App 包名
  version: "5.12.3",                // 可读版本号
  versionCode: 51202,                   // 内部版本号（可选整数）
 ...
 cachedUpdateInfo: [
  ...
  downloadUrl: "https://unionkey.io/mobile/app.apk", // 下载地址
  customMessageTitle: "注意事项",        // 可选自定义消息标题
  customMessagePayload: "请先备份数据", // 可选自定义消息内容
  issueUrls: [                           // 可选 issue 链接数组
    "https://github.com/example/repo/issues/123",
    "https://github.com/example/repo/issues/124"
  ]
};
